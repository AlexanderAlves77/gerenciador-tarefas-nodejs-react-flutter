...
class UsuarioService {
  async cadastrar(dadosUsuario) {
    ...
    if (!dadosUsuario.nome || !dadosUsuario.nome.toString()) {
    ...
    if (!dadosUsuario.email || !dadosUsuario.email.toString()) {
      ...
      if (!temArroba || !temPonto) {
        ...
        const usuarioComMesmoEmail = await UsuarioRepository.filter({
