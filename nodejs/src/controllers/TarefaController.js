...
class TarefaController extends HttpController {
    ...
    async cadastrar(req, res) {
        ...
        try {
            ...
            return res.json({ msg: 'Tarefa cadastrada com sucesso.' })
            
        } catch (e) {
            req.logger.error('erro ao processar requisição de cadastro de tarefas.', `erro=${e.message}`)
    ...
    async editar(req, res) {
        ...
        try {
            ...
            req.logger.error('erro ao processar requisição de edição de tarefas.', `erro=${e.message}`)
    ...
    async deletar(req, res) {
        ...
        try {
            ...
            req.logger.error('erro ao processar requisição de remoção de tarefas.', `erro=${e.message}`)
